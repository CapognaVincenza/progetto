jQuery("#simulation")
  .on("click", ".s-d4bfb88e-084b-430a-b406-fbcc110de5b5 .click", function(event, data) {
  ...
  .on("pageload", ".s-d4bfb88e-084b-430a-b406-fbcc110de5b5 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Panel_nessunaDisdetta")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Panel_nessunaDisdetta" ],
                    "transition": "slideleft"
                  },
                  "exectype": "serial",
                  "delay": 0
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Panel_DisdettaAttiva")) {
      cases = [
        {
          "blocks": [
            {
