jQuery("#simulation")
  .on("click", ".s-ba8b7b67-8166-4cc5-8d2d-4b5eb3bdbb75 .click", function(event, data) {
  ...
  .on("pageload", ".s-ba8b7b67-8166-4cc5-8d2d-4b5eb3bdbb75 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Panel_NessunMessaggio")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Panel_NessunMessaggio" ],
                    "transition": "flow"
                  },
                  "exectype": "serial",
                  "delay": 0
