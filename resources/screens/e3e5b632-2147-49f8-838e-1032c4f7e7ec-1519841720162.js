jQuery("#simulation")
  .on("click", ".s-e3e5b632-2147-49f8-838e-1032c4f7e7ec .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/4f0af537-82b4-45ba-b708-2c86b7a60cdb",
  ...
  .on("pageload", ".s-e3e5b632-2147-49f8-838e-1032c4f7e7ec .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Panel_NessunaPrenotazioni")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Panel_NessunaPrenotazioni" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Panel_PrenotazionePresente")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Panel_PrenotazionePresente" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeMedico")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeVisita_1")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-NomeVisita_1","#s-Text_13","#s-Ellipse_2","#s-Text_14","#s-Text_15","#s-NomeMedico_1","#s-Input_6" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeMedico_1")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeMedico_2")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                ...
                },
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Text_18","#s-Text_16","#s-NomeMedico_2","#s-Input_8","#s-Text_20","#s-NomeVisita_2" ],
                    "effect": {
                      "type": "explode",
                      "duration": 500
                    }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeVisita_3")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-NomeVisita_3","#s-Text_23","#s-Ellipse_4","#s-Text_24","#s-Text_25","#s-NomeMedico_3","#s-Input_9" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-NomeMedico_3")) {
      cases = [
        {
          "blocks": [
            {
