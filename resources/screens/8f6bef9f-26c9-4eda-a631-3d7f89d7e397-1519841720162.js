jQuery("#simulation")
  .on("click", ".s-8f6bef9f-26c9-4eda-a631-3d7f89d7e397 .click", function(event, data) {
  ...
  .on("pageload", ".s-8f6bef9f-26c9-4eda-a631-3d7f89d7e397 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Text_32")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Text_38","#s-Text_35","#s-Text_36","#s-Text_33","#s-Text_34","#s-Text_37","#s-Text_32" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                },
