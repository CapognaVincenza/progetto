jQuery("#simulation")
  .on("click", ".s-1d849fec-3b3d-4c99-87ca-90179266a7ab .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/2f70f722-6d9b-436c-9f09-df6074838cd5"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a722af5b-297c-42b1-862a-bd6269edf8b9",
                    "transition": "slideup"
                  },
                  "exectype": "serial",
                  "delay": 0
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/e28dc09c-76f2-42e8-9d19-1565781419f5",
                    "transition": "slideup"
                  },
                  "exectype": "serial",
                  "delay": 0
  ...
  .on("pageload", ".s-1d849fec-3b3d-4c99-87ca-90179266a7ab .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Ellipse_MarioRossi")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Image_MarioRossi")) {
      cases = [
        {
          "blocks": [
            {
