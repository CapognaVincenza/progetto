...
public class Test {
   ...
   //empty point
	...
	public  void sj10Method(String s, JSONObject j, JSONStringers jj) {
	...
	public  void sj8Meyhod(String s, JSONObject j, JSONArray ja) {
	...
	public  void sj7Method(String s, JSONArray ja, JSONObject j) {
	...
	public  void jCookieMethod(JSONObject j) {
	...
	public  void jCookieListMethod(JSONObject j) {
	...
	public  void jNewJsonMethod(JSONObject j) {
	...
	public  void jXMLMethod(JSONObject j) {
	...
	public  void jNewJson2Method(JSONObject j) {
	...
	public  void jHTTPMethod(JSONObject j) {
	...
	public  void sj6Method(JSONObject j) {
	...
	public  void jtMethod(JSONObject j) {
	...
	public  void sj5Method(JSONObject j, int i, JSONArray a, String s) {
	...
	public  void ajMethod(JSONObject j, JSONArray a) {
		 System.out.println("\naccumulate: ");
	        j = new JSONObject();
	...
	public  void jPutMethod(JSONObject j, JSONArray a ) {
	...
	public  void a2Method(JSONArray a) {
	...
	public  void jIfMethod(JSONobject j) {
	...
	public  void sjMehod(String s, JSONObject j, JSONArray ja) {
