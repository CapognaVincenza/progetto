...
public class Test {
   ...
   //empty point
	...
	public static void sj14Method(JSONObject j, Object o,String s, JSONArray a ) {
		s = "[0.1]";
        a = new JSONArray(s);
        System.out.println(a.toString());
        System.out.println("");
	...
	public static void sj13Method(String s, JSONObject j, JSONArray a) {
	...
	public static void sj12Method(String s, JSONObject j, JSONArray a) {
	...
	public static void sj11Method(String s, JSONObject j) {
	...
	public static void sj10Method(String s, JSONObject j, JSONStringers jj) {
	...
	public static void sj9Method(JSONObject j, JSONArray a) {
	...
	public static void ja2Method(JSONObject j, JSONArray a, Collection c, Map m) {
		j = new JSONObject(m);
        a = new JSONArray(c);
	...
	public static void aMethod(JSONArray a, String s) {
		a = JSONML.toJSONArray(s);
        System.out.println(a.toString(4));
        System.out.println(JSONML.toString(a));
	}
	
	public static void sMethod(String s, JSONObject j) {
	...
	public static void sj3Method(String s, JSONObject j, JSONArray a) {
	...
	public static void saMethod(String s, JSONArray a) {
		 s = " (\"San Francisco\", \"New York\", \"Seoul\", \"London\", \"Seattle\", \"Shanghai\")";
	     a = new JSONArray(s);
	     System.out.println(a.toString());
	}
	
	public static void sj2Method(String s, JSONObject j, JSONArray a) {
	...
	public static void jaMethod(JSONArray ja, String s, JSONObject j) {
		ja = JSONML.toJSONArray(s);
        System.out.println(ja.toString(4));
        System.out.println(JSONML.toString(ja));
        System.out.println("");
