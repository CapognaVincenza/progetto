...
public class Test {
   ...
   //empty point
	...
	public static void sJMethod(String s, JSONObject j, JSONArray a, JSONArray ja) {
	...
	public static void sJ2Method(String s, JSONObject j, JSONArray a,  Collection c, Map m,  Iterator it) {
